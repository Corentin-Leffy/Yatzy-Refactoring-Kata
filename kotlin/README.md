...
Ce kata est tiré du [Yatzy Refactoring Kata](https://github.com/emilybache/Yatzy-Refactoring-Kata) proposé par Emily Bache.

Dans cette version, il n'y a qu'un projet en Kotlin, utilisant [kotest](https://github.com/kotest/kotest) pour les tests.

Pour pouvoir travailler efficacement sur cet exercice, vous devez avoir :
- un IDE Java (je vous conseille vivement [IntelliJ IDEA](https://www.jetbrains.com/idea/download/) mais [Eclipse](https://www.eclipse.org/ide/) peut faire l'affaire)
- 
